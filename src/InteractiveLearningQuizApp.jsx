...
export default function InteractiveLearningQuizApp({ entryRequest, onExit, hideOwnOnlineBadge }) {
  ...
  return (
    <>
      ...
      <OnlineStatusWidget
        ...
        coinIcon="🪙"
        onCoinClick={studentName ? () => window.__ilqApp?.depositCoinsToShrineRoom?.() : undefined}
