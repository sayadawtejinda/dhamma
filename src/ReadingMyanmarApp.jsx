...
export default function ReadingMyanmarApp({ entryRequest, onExit }) {
  ...
  // Consonant Practice (Part 1), Burmese Consonant Game (Part 2), and Sound
  // Practice (Part 6) already show the shared OnlineStatusWidget themselves
  // -- with their own coin balance/group/level activity, richer than this
  // generic group-wide one -- so each takes over instead of stacking two
  // pills. The other parts aren't migrated to their own widget yet, so this
  ...
  const OWN_WIDGET_PARTS = ['consonantpractice', 'burmesegame', 'soundpractice'];
