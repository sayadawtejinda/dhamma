...
// a single roster/online-status feed for the whole group, and a way to
// jump back to that landing screen from inside any part instead of
...
export default function ReadingMyanmarApp({ entryRequest, onExit }) {
  ...
  // the 6 parts pinging its own separate roster.
  useEffect(() => {
