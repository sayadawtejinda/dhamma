...
export default function MyanmarPart2AApp({ entryRequest, onExit, hideOwnOnlineBadge }) {
  ...
  useEffect(() => {
    ...
    const rosterRef = rosterDocRefByUid(db, P2A_ROSTER_PATH, studentUid);
    migrateNameKeyedRosterDoc(db, P2A_ROSTER_PATH, studentUid, studentName, sanitizeP2aKey)
  ...
  useEffect(() => {
    const unsub = listenLiveOrOnce(collection(db, P2A_ROSTER_PATH), (snap) => {
