...
export default function BurmeseLearningGamesApp({ entryRequest, onExit, hideOwnOnlineBadge }) {
    ...
    <>
      ...
      {!hideOwnOnlineBadge && (
        <OnlineStatusWidget
          ...
          coinIcon="🪙"
          onCoinClick={studentName ? () => window.__blgApp?.depositCoinsToShrineRoom?.() : undefined}
          panelTitle="🎮 Students"
          renderActivity={s => (
